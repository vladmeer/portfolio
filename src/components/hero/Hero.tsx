...
import { ArrowDown, Download, Github, Linkedin, Mail, Youtube } from 'lucide-react';
        ...
        <div className="space-y-8 text-center lg:text-left">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center lg:justify-start">
              <ScrollButton
                targetId="contact"
                className="glow-button font-semibold px-8 py-6 text-lg inline-flex items-center justify-center rounded-md ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2"
